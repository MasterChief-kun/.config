...
elseif($action -eq "stop") {
    ...
    $stopCommand = "sudo docker stop $(sudo docker ps -aq --filter="name=testContainers*")"
...
elseif($action -eq "delete") {
    ...
    $deleteCommand = "sudo docker rm $(sudo docker stop $(sudo docker ps -aq --filter="name=testContainers*"))"
